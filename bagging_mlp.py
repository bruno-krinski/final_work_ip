...
def main(argv):
    if len(argv) != 2:
        print("Use mode: python bagging_mlp.py <mode>")
    ...
    if mode == "val":
        for d in data:
            ...
            bagging_mlp_validation(data_features,data_labels,d)
    elif mode == "test":
        ...
        bagging_mlp_test(train_features,train_labels,test_features,test_labels)
    else:
        print("Unknown mode!")
